...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <table class="form">
        ...
        <tr>
            <td>
                <span class="chkUSDA">
                    <asp:CheckBox ID="chkAddress" runat="server" Text=" Has address?" Checked="true" ControlStyle-CssClass="checkBox" OnCheckedChanged="toggleAddress" AutoPostBack="true"/>
                </span>
            </td>
        </tr>
    ...
    <asp:Panel ID="addressDiv" runat="server">
        <table class="form">
        <h2>Address</h2>
        <tr>
