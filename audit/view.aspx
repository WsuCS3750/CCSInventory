...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolder_PageTitle" Runat="Server">
    <img src="../images/icon-clipboard.png" />View Adjustments
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    <asp:Label ID="lblMessage" runat="server" Text="" ForeColor="Red"></asp:Label>
    <asp:Label ID="lblNoAdjustments" runat="server" Text="No adjustments were made during this audit." Visible="false"></asp:Label>
    ...
    <asp:LinkButton ID="btnBack" runat="server" CssClass="cancel" onclientclick="JavaScript: window.history.go(-1); return false;">Back</asp:LinkButton>
</asp:Content>
