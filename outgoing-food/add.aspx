...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolder_PageTitle" Runat="Server">
    <img src="../images/icon-arrow.png" />Add Outgoing Food
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <h1>Add Outgoing Food</h1>
        <p class="smallFont">This page is for one-time out-going food transactions that are not in inventory. Did you mean to <a href="../container/scan.aspx">move-out a bin or USDA pallet?</a></p>
    ...
    <table class="buttonGroup cols-3">
        ...
        <tr id="nonUSDA2" class="spaceBelow" runat="server">
            <td>Category Type:</td>
