...
<body onload="window.print()">
    ...
    &nbsp;<a onclick="JavaScript: window.history.go(-1); return false;" class="submit hide">Back </a>&nbsp;<div id="printarea" style="font-family:Calibri">
         <div class="center"><img  src="<%= Config.DOMAIN() %>images/ccs-logo.png" /> </div>
        ...
        <table runat="server" id="tableItems"> 
            <tr>
        ...
        <div id="volunteer-hours">
            ...
            <br />
             <br />
            <span class="label">Estimated Value (<em>Determined by Donor</em>)</span><asp:Label runat="server" CssClass="info" ID="lblEstimatedValue" Width="75px"/>
        </div>
        <br />
