...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolder_PageTitle" Runat="Server">
    <img src="../images/icon-arrow.png" />Incoming Food
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <asp:GridView ID="grdFoodIn" CssClass="dataTable mediumFont" runat="server" AllowPaging="True" CellPadding="5" 
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="printInKind" runat="server" OnClick="PrintClick" CommandArgument='<%# Bind("Id") %>'
                        Text="Print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" Style="padding: 6px 6px;" CssClass="button"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
