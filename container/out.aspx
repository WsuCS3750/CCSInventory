...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td><asp:Label ID="lblFoodSourceType" runat="server" Text=""></asp:Label></td>
            </tr>
        </table>
    </fieldset>
    <h2>Move Reason:</h2>
    ...
    <table>
        <tr>
            <td>Delete Container from Database: </td>
            <td><asp:CheckBox runat="server" ID="chkDelete" CssClass="checkBox" Checked="True"/></td>
        </tr>
    </table>
