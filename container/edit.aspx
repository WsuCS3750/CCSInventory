...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <table class="form">
        ...
        <tr> <!--class="usda"-->
            ...
            <td>
                <asp:TextBox ID="txtNumberOfCases" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>Location</td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlFoodSourceType" runat="server" AppendDataBoundItems="true"
    ...
    <table class="buttonGroup cols-3">
        <tr>
            <td><asp:LinkButton ID="btnCancel" runat="server" Text="Cancel" CssClass="delete cancel" OnClick="btnCancel_Click" /></td>
    ...
    <asp:HiddenField ID="hdnCases" runat="server" />        
