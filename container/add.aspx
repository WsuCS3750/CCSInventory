...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <table class="form">
        <tr>
            ...
            <td><asp:CheckBox ID="chkAutoGen" runat="server" CssClass="checkBox"  Checked="true"/></td>
        </tr>
        <tr>
            <td>Bin number</td>
            <td><asp:TextBox ID="txtBinNumber" runat="server" type="number" Enabled="false"></asp:TextBox></td>
        </tr>
    </table>
