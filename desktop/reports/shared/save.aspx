<%@ Page Title="" Language="C#" MasterPageFile="~/mobile.master" AutoEventWireup="true" CodeFile="save.aspx.cs" Inherits="desktop_reports_incoming_Default" %>
...
&nbsp;<asp:TextBox ID="txtTitle" runat="server" Height="36px" Width="751px"></asp:TextBox>
        <br />
</div>
