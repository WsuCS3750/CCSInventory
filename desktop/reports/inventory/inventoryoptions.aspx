...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    <h1>Inventory Report Options</h1>
        ...
        <asp:Label ID="Label1" runat="server" Text="Group By" Font-Bold="True" Font-Size="20pt"></asp:Label>
              <br />
        <br />
              <asp:RadioButton ID="rbCategory" runat="server" Text="Category" Font-Size="Small" GroupName="groupBy" AutoPostBack="true" OnCheckedChanged="RadioButton_CheckedChanged" />
              &nbsp;&nbsp;&nbsp;
              <asp:RadioButton ID="rbLocation" runat="server" Text="Location" Font-Size="Small" GroupName="groupBy" AutoPostBack="true" OnCheckedChanged="RadioButton_CheckedChanged" />
              &nbsp;&nbsp;&nbsp;
              <asp:RadioButton ID="rbBinNumber" runat="server" Text="Bin Number" Font-Size="Small" GroupName="groupBy" AutoPostBack="true" OnCheckedChanged="RadioButton_CheckedChanged" />
              <br />
        <br />
    </asp:Panel>
</div>
