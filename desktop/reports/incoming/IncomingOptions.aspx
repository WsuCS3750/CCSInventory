<%@ Page Title="" Language="C#" MasterPageFile="~/mobile.master" AutoEventWireup="true" CodeFile="incomingoptions.aspx.cs" Inherits="desktop_reports_incoming_Incoming_Options" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <br />
        ...
        <br />
              ...
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <asp:CheckBox ID="cbShowDonorAddress" runat="server" Text="Show Donor Address" />
              <br />
        <br />
    </asp:Panel>
</div>
