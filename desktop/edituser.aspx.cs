                ...
                if (Request.QueryString["do"].Equals("e"))
                {
                    ...
                    try
                    {
                        using (CCSEntities db = new CCSEntities())
                        {
                            ...
                            if (userInfoQuery.ToList().ElementAt(0).Admin == true)
                                ddlEditAdmin.SelectedValue = "Yes";
                            else if (userInfoQuery.ToList().ElementAt(0).Admin == false)
                                ddlEditAdmin.SelectedValue = "No";
